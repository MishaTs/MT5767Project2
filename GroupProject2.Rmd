...
The wildebeest (*Connochaetes*) live and move in large herds [@estes2014]. The blue wildebeest (*Connochaetes taurinus*) migrate in a clockwise manner from Serengeti, Tanzania to Masai Mara, Kenya, forming the backbone of the Great Migration in south-eastern Africa [@estes2014]. During this annual crossing of great distances, the blue wildebeest follow annual rain cycles and move along the trajectory. The species also breeds annually dependent on rainfall [@estes2014].

Due to expansion of agriculture, Rinderpest induced by the spread of cattle-farming, and poaching pressure, population of this antelope species faced a steep decline in the 1960s and 70s. Since then, population monitoring has been a key focus of biologists and conservationists. 
